...
describe('Resistor Colors', () => {
  ...
  it('1 kiloohms', () => {
    expect(decodedResistorValue(['brown', 'black', 'red'])).toEqual(
      '1 kiloohms'
    )
  })

  it('1 megaohms', () => {
    expect(decodedResistorValue(['brown', 'black', 'green'])).toEqual(
      '1 megaohms'
    )
  })

  it('1 gigaohms', () => {
    expect(decodedResistorValue(['brown', 'black', 'grey'])).toEqual(
      '1 gigaohms'
    )
  })
})
